...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,chatty-gifts-lie.loca.lt,usafilink-backend.onrender.com').split(',')
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3',  # Use SQLite for now, easier
        'NAME': BASE_DIR / 'db.sqlite3',
    }
}

# If you want MySQL later, uncomment this and comment the SQLite config above:
"""
DATABASES = {
    'default': {
